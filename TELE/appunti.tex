...
\begin{document}
	...
	\begin{center}
        ...
        \begin{flushright}
            ...
            {\large \textbf{Fonte Immagini:}} \\
            \large{Slide di M. Savi}
        \end{flushright}
    ...
    \include{chapters/01-communication-theory-multiplexing-transmission-media}
    \include{chapters/02-broadband-access-networks}
    \include{chapters/03-wide-area-network}
    \include{chapters/04-virtual-private-network}
    \include{chapters/05-networking-devices}
\end{document}
