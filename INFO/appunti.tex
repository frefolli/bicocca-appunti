...
\begin{document}
	...
	\begin{center}
            {\LARGE{
                    \setstretch{1.2}
                    \textbf{Appunti di \\ Teoria dell'Informazione e Crittografia}
                    \par
            }}
        \end{center}
        ...
        \begin{flushright}
            ...
            \large{Slide di A. O. Leporati} \\
            \large{Appunti di D. Cozzi}
        \end{flushright}
    ...
    \part{Crittografia}
    \include{chapters/crittografia/01}
    \include{chapters/crittografia/02}
    \include{chapters/crittografia/03}
\end{document}
