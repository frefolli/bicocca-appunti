@all: TELE/Makefile ARCH/Makefile SCMT/Makefile INFO/Makefile #MCOR/Makefile TCOM/Makefile APAL/Makefile BIOINF/Makefile ROPR/Makefile ROPR/assignments/Makefile APS/Makefile SAF/Makefile
	# make -C APAL
	# make -C BIOINF
	# make -C ROPR
